...
public final class SettingsFragmentPresenter
{
  ...
  private void addGraphicsSettings(ArrayList<SettingsItem> sl)
  {
    ...
    sl.add(new CheckBoxSetting(mContext, BooleanSetting.GFX_SHOW_FTIMES, R.string.show_ftimes,
    ...
    sl.add(new CheckBoxSetting(mContext, BooleanSetting.GFX_SHOW_VTIMES, R.string.show_vtimes,
            R.string.show_vtimes_description));
    sl.add(new CheckBoxSetting(mContext, BooleanSetting.GFX_SHOW_GRAPHS, R.string.show_graphs,
  ...
  private void addAdvancedGraphicsSettings(ArrayList<SettingsItem> sl)
  {
    ...
    sl.add(new CheckBoxSetting(mContext, BooleanSetting.GFX_CPU_CULL, R.string.cpu_cull,
